class ExplorerService{
    ...
    static getExplorersUsernamesByMission(explorers,mission){
        ...
        const explorerUsernames = explorersByMission.map((anyThing) => anyThing.githubUsername); // la constante obtiene la propiedad "githubUsername" de la lista filtrada, usando map
